...
execute join(['function! vital#_amake#System#Job#Neovim#import() abort', printf("return map({'is_available': '', 'start': ''}, \"vital#_amake#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
